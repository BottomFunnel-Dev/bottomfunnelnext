            ...
            <div className={styles.whyChooseUsPlantMeatExpertiseMainDiv}>
                <div className={styles.whyChooseUsPlantMeatExpertiseIconContainer}>
                    ...
                    <div className={styles.whyChooseUsPlantMeatExpertiseIconOuterBox}>
                        <div className={styles.whyChooseUsPlantMeatExpertiseContainerDiv}>
                            <div className={styles.whyChooseUsPlantMeatExpertiseIcon}>
                                <img src='/Images/PlantBasedMeat/icons/support.png' alt='images' />
                            </div>
                            <div className={styles.whyChooseUsPlantMeatExpertiseIconHeading}>
                ...
                <div className={styles.whyChooseUsPlantMeatExpertiseContent}>
                    ...
                    <p className={styles.whyChooseUsPlantMeatExpertiseContentText}>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem maiores voluptates, odio illum corporis aliquam earum officia vitae, quam blanditiis eum non molestias tenetur? Autem perferendis amet dicta saepe tenetur.
