...
export const phpData = {
  ...
  RemarkableData: {
    ...
    description: `PHP is the most widely-used language for web development. No wonder why it's so easy to find and requires minimal support. All you need is a web browser and an internet connection, and you're ready to go. Updates are released regularly, and bug fixes are made quickly. If this sounds good to you, sign up today!`,
    cardsData: [
      {
        img: {
...
export const ginData = {
  title: "gin framework services | Bottom Funnel Technologies PVT. LTD.",
  description:
    "Bottom Funnel, an app that helps you build a business around your content. With modern tools like a website, newsletter, and paid subscriptions, it's the perfect way to grow your audience online",
  isBanner: true,
  BannerData: {
    image: "/Images/skillsPhotos/ginSkillsPhotos/banner.webp",
    title: "Gin Framework Development Services",
    description:
      "Delivering on your business vision with quality Weebly website builder and web hosting experts.",
  },
  isDes: true,
  desData: {
    title: "Gin",
    image: "/Images/skillsPhotos/ginSkillsPhotos/gin-logo.webp",
    description:
      "Bottom Funnel, an app that helps you build a business around your content. With modern tools like a website, newsletter, and paid subscriptions, it's the perfect way to grow your audience online! And with Ghost, you'll have an easy way to publish your content on the go without sacrificing quality.",
  },
  isWhyApp: true,
  WhyAppData: {
    title: "POPULAR GIN WEB DEVELOPMENT SERVICES",
    cardsData: [
      {
        img: {
          src: "/Images/skillsPhotos/ginSkillsPhotos/cloud.webp",
          alt: "ginSkillsPhotos/cloud.webp",
        },
        title: "Open Source",
      ...
      {
        img: {
          src: "/Images/skillsPhotos/ginSkillsPhotos/speed.webp",
          alt: "ginSkillsPhotos/speed.webp",
        },
      ...
      {
        img: {
          src: "/Images/skillsPhotos/ginSkillsPhotos/storage.webp",
          alt: "ginSkillsPhotos/storage.webp",
        },
      ...
      {
        img: {
          src: "/Images/skillsPhotos/ginSkillsPhotos/router.webp",
          alt: "ginSkillsPhotos/router.webp",
        },
        title: "Routing",
        description:
          "Ghost is an excellent choice for SEO-savvy businesses. Built-in SEO options help your website rank higher in search results, while built-in security safeguards your online reputation.",
      ...
      {
        img: {
          src: "/Images/skillsPhotos/ginSkillsPhotos/right.webp",
          alt: "ginSkillsPhotos/right.webp",
        },
        title: "Simple and productive",
        description:
          "Ghost is here to help! With its comprehensive plugin, you can export your data and import it into WordPress with just a few clicks. Ghost is one such plugin that makes transferring data easy.",
      ...
      {
        img: {
          src: "/Images/skillsPhotos/ginSkillsPhotos/checked.webp",
          alt: "ginSkillsPhotos/checked.webp",
        },
        title: "Easy to use",
        description:
          "Ghost is a lightweight alternative of WordPress that focuses on blogging. It's fast, reliable, and easy to use - meaning you can focus on enjoying blogging without worrying about technicalities.",
  ...
  isWhyBF: true,
  WhyBFData: {
    title: "Why Bottom Funnel for gin",
    image: "/Images/skillsPhotos/ginSkillsPhotos/big-left-image.webp",
    bulletPointData: [
      "We use an agile approach.",
      "Provides integrity and transparency.",
      "Commitments with NDA agreements.",
      "Flexible engagement models.",
      "Experienced and talented team of developers.",
      "Offers variety of exclusive gin solutions.",
    ],
  },
  isBookCall: true,
  BookCallData: {
    title: "Need our gin developers to build your application?",
    btn: "Book a call now",
    image: "/Images/skillsPhotos/yiiSkillsPhotos/mid-banner.webp",
  },
  isRemarkable: true,
  RemarkableData: {
    title: "benefits of using gin",
    description: "",
    cardsData: [
      {
        img: {
...
export const shopifyData = {
  title: "shopify framework services | Bottom Funnel Technologies PVT. LTD.",
  description:
    "Bottom Funnel, an app that helps you build a business around your content. With modern tools like a website, newsletter, and paid subscriptions, it's the perfect way to grow your audience online",
  isBanner: true,
  BannerData: {
    image: "/Images/skillsPhotos/shopifySkillsPhotos/banner.webp",
    title: "Shopify Framework Development Services",
    description:
      "Delivering on your business vision with quality Weebly website builder and web hosting experts.",
  },
  isDes: true,
  desData: {
    title: "Shopify",
    image: "/Images/skillsPhotos/shopifySkillsPhotos/shopify-logo.webp",
    description:
      "Bottom Funnel, an app that helps you build a business around your content. With modern tools like a website, newsletter, and paid subscriptions, it's the perfect way to grow your audience online! And with Ghost, you'll have an easy way to publish your content on the go without sacrificing quality.",
  },
  isWhyApp: true,
  WhyAppData: {
    title: "POPULAR shopify WEB DEVELOPMENT SERVICES",
    cardsData: [
      {
        img: {
          src: "/Images/skillsPhotos/shopifySkillsPhotos/checked.webp",
          alt: "shopifySkillsPhotos/checked.webp",
        },
      ...
      {
        img: {
          src: "/Images/skillsPhotos/shopifySkillsPhotos/automated.webp",
          alt: "shopifySkillsPhotos/automated.webp",
        },
      ...
      {
        img: {
          src: "/Images/skillsPhotos/shopifySkillsPhotos/community.webp",
          alt: "shopifySkillsPhotos/community.webp",
        },
      ...
      {
        img: {
          src: "/Images/skillsPhotos/shopifySkillsPhotos/dasktop.webp",
          alt: "shopifySkillsPhotos/dasktop.webp",
        },
        title: "Mobile ready",
        description:
          "Ghost is an excellent choice for SEO-savvy businesses. Built-in SEO options help your website rank higher in search results, while built-in security safeguards your online reputation.",
      ...
      {
        img: {
          src: "/Images/skillsPhotos/shopifySkillsPhotos/setting.webp",
          alt: "shopifySkillsPhotos/setting.webp",
        },
        title: "Customisable",
        description:
          "Ghost is here to help! With its comprehensive plugin, you can export your data and import it into WordPress with just a few clicks. Ghost is one such plugin that makes transferring data easy.",
      ...
      {
        img: {
          src: "/Images/skillsPhotos/shopifySkillsPhotos/secure.webp",
          alt: "shopifySkillsPhotos/secure.webp",
        },
        title: "Own payment gateway",
        description:
          "Ghost is a lightweight alternative of WordPress that focuses on blogging. It's fast, reliable, and easy to use - meaning you can focus on enjoying blogging without worrying about technicalities.",
      },
    ],
  ...
  isWhyBF: true,
  WhyBFData: {
    title: "Why Bottom Funnel for shopify",
    image: "/Images/skillsPhotos/shopifySkillsPhotos/big-left-image.webp",
    bulletPointData: [
      "We use an agile approach.",
      "Provides integrity and transparency.",
      "Commitments with NDA agreements.",
      "Flexible engagement models.",
      "Experienced and talented team of developers.",
      "Offers variety of exclusive shopify solutions.",
    ],
  },
  isBookCall: true,
  BookCallData: {
    title: "Need our shopify developers to build your application?",
    btn: "Book a call now",
    image: "/Images/skillsPhotos/yiiSkillsPhotos/mid-banner.webp",
  },
  isRemarkable: true,
  RemarkableData: {
    title: "benefits of using shopify",
    description: "",
    cardsData: [
      {
        img: {
